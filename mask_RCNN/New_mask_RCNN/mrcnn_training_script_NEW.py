...
# FILL IN the correct beginning of this path
sys.path.append(r'path\to\tracking\code\tracking-and-scoring-nictation\mask_RCNN\helper_functions')
...
model_file = r'path\to\tracking\code\tracking-and-scoring-nictation\mask_RCNN\your_folder\202YMMDD_model_name.pt'
...
if train:
    ...
    torch.save(model.state_dict(), mode_filename)
