...
class Eigenworm_model():
    ...
    def centerline_to_parameters(self):
        ...
        #
        # angles_fit = angles - (rot+30)
        # angles_fit = angles
        if self.angles_mean == []:
            self.angles_mean = np.mean(angles)
        angles_fit = angles - self.angles_mean
    ...
    def extend_in_track(self, direction = 1, amount = 0.01):
        ...
        ####
        self.angles_mean = np.mean(self.angles)
