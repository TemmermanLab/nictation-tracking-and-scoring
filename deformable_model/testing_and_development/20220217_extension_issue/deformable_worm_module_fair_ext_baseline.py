...
IN THIS VERSION, THE BASELINE LOSS FOR EXTENSION / CONTRACTION PURPOSES IS 
CALCULATED BY RUNNING THE CENTERLINE THRU THE CENTERLINE TO PARAMETERS METHOD 
FIRST.
...
class Eigenworm_model():
    ...
    def centerline_to_parameters(self):
        ...
        angles_fit = angles - np.mean(angles)
        ...
        X = np.linalg.lstsq(A,np.radians(angles_fit),rcond=None)
