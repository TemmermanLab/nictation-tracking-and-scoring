...
def bar_count(dataframe):
    ...
    palette_sns = {'cruising':palette[3]/255, 'waving':palette[4]/255, 
               'standing':palette[5]/255, 'quiescent':palette[2]/255,
               'censored':palette[1]/255}
    fig, ax = plt.subplots(figsize=(6,4))
    sns.countplot(dataframe['behavior'],ax=ax,label="Count",palette = palette_sns)
    plt.show()
