...
Known issues and possible improvements:
    ...
    -grab current values when existing from parameter GUI (should be separate function for updating params)
    ...
    -scale parameter GUI text to make it easy to see at different image resolutions
