...
to account for changes in how centerlines are saves, flagged, etc.
...
def show_covar_matrix(M, txt = "Postural Covariance Matrix"):
    ...
    ax.set_xticks((-.5,98.5))
    ax.set_xticklabels(('0','1'))
    ax.set_ylabel('Body coordinate')
    ax.set_yticks((-0.5,98.5))
...
try:
    ...
    # load
    filename = r'C:\Users\PDMcClanahan\Dropbox\Temmerman_Lab\code\tracking\tracker_V2\testing_files\20211212_angles.p'
    ...
    filename = r'C:\Users\PDMcClanahan\Dropbox\Temmerman_Lab\code\tracking\tracker_V2\testing_files\20211212_Sc_eigenworms.p'
    with open(filename, 'wb') as f:
